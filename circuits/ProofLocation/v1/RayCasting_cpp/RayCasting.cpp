...
void RayCasting_7_create(uint soffset,uint coffset,Circom_CalcWit* ctx,std::string componentName,uint componentFather);
void RayCasting_7_run(uint ctx_index,Circom_CalcWit* ctx);
...
uint get_total_signal_no() {return 4213;}

uint get_number_of_components() {return 57;}

uint get_size_of_input_hashmap() {return 256;}

uint get_size_of_witness() {return 4064;}
...
ctx->componentMemory[coffset].templateName = "RayCasting";
ctx->componentMemory[coffset].signalStart = soffset;
...
uint csoffset = mySignalStart+2619;
...
uint csoffset = mySignalStart+3919;
uint aux_dimensions[1] = {5};
for (uint i = 0; i < 5; i++) {
...
uint csoffset = mySignalStart+3959;
for (uint i = 0; i < 1; i++) {
...
Fr_lt(&expaux[0],&lvar[1],&circuitConstants[6]); // line circom 42
while(Fr_isTrue(&expaux[0])){
{
PFrElement aux_dest = &lvar[2];
// load src
Fr_add(&expaux[1],&lvar[1],&circuitConstants[2]); // line circom 43
Fr_mod(&expaux[0],&expaux[1],&circuitConstants[6]); // line circom 43
// end load src
Fr_copy(aux_dest,&expaux[0]);
}
{
...
// load src
// end load src
Fr_copy(aux_dest,&signalValues[mySignalStart + (((2 * Fr_toInt(&lvar[1])) + 1) + 1)]);
}
...
// load src
// end load src
Fr_copy(aux_dest,&signalValues[mySignalStart + (((2 * Fr_toInt(&lvar[2])) + 1) + 1)]);
}
// run sub component if needed
if(!(ctx->componentMemory[mySubcomponents[cmp_index_ref]].inputCounter -= 1)){
LessThan_1_run(mySubcomponents[cmp_index_ref],ctx);
...
PFrElement aux_dest = &lvar[3];
// load src
Fr_sub(&expaux[0],&signalValues[mySignalStart + (((2 * Fr_toInt(&lvar[2])) + 0) + 1)],&signalValues[mySignalStart + (((2 * Fr_toInt(&lvar[1])) + 0) + 1)]); // line circom 53
// end load src
Fr_copy(aux_dest,&expaux[0]);
}
{
...
// load src
Fr_sub(&expaux[0],&signalValues[mySignalStart + (((2 * Fr_toInt(&lvar[2])) + 1) + 1)],&signalValues[mySignalStart + (((2 * Fr_toInt(&lvar[1])) + 1) + 1)]); // line circom 54
// end load src
Fr_copy(aux_dest,&expaux[0]);
}
{
...
// load src
Fr_sub(&expaux[1],&signalValues[mySignalStart + 11],&signalValues[mySignalStart + (((2 * Fr_toInt(&lvar[1])) + 0) + 1)]); // line circom 55
Fr_mul(&expaux[0],&expaux[1],&lvar[4]); // line circom 55
// end load src
Fr_copy(aux_dest,&expaux[0]);
}
{
...
// load src
Fr_sub(&expaux[1],&signalValues[mySignalStart + 12],&signalValues[mySignalStart + (((2 * Fr_toInt(&lvar[1])) + 1) + 1)]); // line circom 56
Fr_mul(&expaux[0],&lvar[3],&expaux[1]); // line circom 56
// end load src
Fr_copy(aux_dest,&expaux[0]);
}
{
...
// load src
// end load src
Fr_copy(aux_dest,&ctx->signalValues[ctx->componentMemory[mySubcomponents[((1 * Fr_toInt(&lvar[1])) + 15)]].signalStart + 0]);
}
// run sub component if needed
if(!(ctx->componentMemory[mySubcomponents[cmp_index_ref]].inputCounter -= 1)){
AND_3_run(mySubcomponents[cmp_index_ref],ctx);
...
{
uint cmp_index_ref = ((1 * Fr_toInt(&lvar[1])) + 25);
{
PFrElement aux_dest = &ctx->signalValues[ctx->componentMemory[mySubcomponents[cmp_index_ref]].signalStart + 1];
// load src
// end load src
...
PFrElement aux_dest = &ctx->signalValues[ctx->componentMemory[mySubcomponents[cmp_index_ref]].signalStart + 2];
// load src
Fr_add(&expaux[0],&signalValues[mySignalStart + ((1 * Fr_toInt(&lvar[1])) + 13)],&circuitConstants[2]); // line circom 70
// end load src
Fr_copy(aux_dest,&expaux[0]);
}
// run sub component if needed
...
{
PFrElement aux_dest = &signalValues[mySignalStart + ((1 * (Fr_toInt(&lvar[1]) + 1)) + 13)];
// load src
// end load src
Fr_copy(aux_dest,&ctx->signalValues[ctx->componentMemory[mySubcomponents[((1 * Fr_toInt(&lvar[1])) + 25)]].signalStart + 0]);
}
{
PFrElement aux_dest = &lvar[1];
// load src
Fr_add(&expaux[0],&lvar[1],&circuitConstants[2]); // line circom 42
// end load src
Fr_copy(aux_dest,&expaux[0]);
}
Fr_lt(&expaux[0],&lvar[1],&circuitConstants[6]); // line circom 42
...
RayCasting_7_create(1,0,ctx,"main",0);
RayCasting_7_run(0,ctx);
}
